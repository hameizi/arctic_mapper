...
public interface CatalogMetadataMapper {
  ...
  @Results({
      ...
      @Result(property = "catalogMetastore", column = "catalog_type"),
  ...
  @Insert("replace into " + TABLE_NAME +
      ...
      "(#{catalogMeta.catalogName}, #{catalogMeta.catalogMetastore}, #{catalogMeta" +
  ...
  @Update("update " + TABLE_NAME  + " set catalog_metastore=#{catalogMeta.catalogMetastore},"  +
