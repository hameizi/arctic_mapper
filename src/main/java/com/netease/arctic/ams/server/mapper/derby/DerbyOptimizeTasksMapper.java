...
public interface DerbyOptimizeTasksMapper extends OptimizeTasksMapper {
  ...
  @Insert("insert into " + TABLE_NAME + " (" +
      " procedure_id, task_id, task_type, table_id, partition," +
      " max_change_transaction_id, min_change_transaction_id," +
      " create_time, start_time, cost_time, status, fail_reason, optimizer_id, thread_id," +
      " insert_file_size, delete_file_size, base_file_size, pos_delete_file_size," +
      " insert_file_count, delete_file_count, base_file_count, pos_delete_file_count," +
      " source_nodes,retry_count, new_file_size,new_file_count,properties)" +
      " values(" +
      ...
      " #{optimizeTaskRuntime.retryCount}," +
