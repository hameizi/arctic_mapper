...
public interface DerbyCatalogMetadataMapper extends CatalogMetadataMapper {
  ...
  @Insert("MERGE INTO " +
          ...
          "catalog_metastore=#{catalogMeta.catalogMetastore}, storage_configs=" +
          ...
          "typeHandler=com.netease.arctic.ams.server.mybatis.Map2StringConverter}" +
          "WHEN NOT MATCHED THEN INSERT (catalog_name, catalog_metastore, storage_configs, auth_configs, " +
          "catalog_properties) VALUES (#{catalogMeta.catalogName}, " +
          "#{catalogMeta.catalogMetastore}, #{catalogMeta" +
